...
const student_constance_1 = require("../student/student.constance");
const createStudentZodSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        student: zod_1.z.object({
            ...
            gender: zod_1.z.enum([...student_constance_1.gender], {
            ...
            bloodGroup: zod_1.z.enum([...student_constance_1.bloodGroup]).optional(),
...
const createAdminZodSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        admin: zod_1.z.object({
            ...
            bloodGroup: zod_1.z.enum([...student_constance_1.bloodGroup], {
                required_error: 'Gender is required',
            }),
            email: zod_1.z
                .string({
