...
const academicSemesterSchema = new mongoose_1.Schema({
    title: { type: String, enum: academicSemester_constant_1.academicSemesterTitles, required: true },
    year: { type: String, required: true },
    code: { type: String, enum: academicSemester_constant_1.academicSemesterCodes, required: true },
...
academicSemesterSchema.pre('save', function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (isExit) {
            throw new ApiError_1.default(http_status_1.default.CONFLICT, 'Academic Semester is Exist ❗❗');
        }
        next();
    });
});
